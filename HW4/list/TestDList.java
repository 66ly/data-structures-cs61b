  ...
  public static void main (String[] args) {
    ...
    System.out.println("Here is the same list after insertBack(15) and insertFront(3): "
		       + sl1.toString());
    DList sl2 = new DList();
    sl2.insertBack(new Integer(99));
    sl2.insertBack(new Integer(29));
    System.out.println("here is a list 2 : " + sl2.toString()+"  size is "+sl2.size);
    DListNode node1 = sl1.front();
    sl2.remove(node1);
    System.out.println("after remove  " + sl2.toString()+"  size is  "+sl2.size);
    System.out.println("after remove  " + sl1.toString()+"  size is  "+sl1.size);
    newtest(sl1);
