...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    System.out.println("the number of entries is "+ table.size());
    System.out.println("the number of buckets is "+ table.bucketsize());
    System.out.println("the number of collision is "+ table.numberOfcollision());
    System.out.println("the expected number of collision is "+ table.expectedCollision());
  }
